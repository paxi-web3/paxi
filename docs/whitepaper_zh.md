...
你目前的白皮書結構非常清晰，若要加入 AMM（自動做市商）系統的介紹，建議新增一節：

---

## ✅ 推薦加入位置：**新開一節，放在「應用場景」之後**

這樣可以形成自然的銜接邏輯：

> 通膨機制 → 代幣分配 → DAO 治理 → 應用場景 → 🔥 **AMM 系統（DeFi 核心基礎設施）** → 開發者體驗 → 結語
...
* **低滑價與手續費**：針對小型交易優化曲線，內建 Swap 手續費為 0.3%（可由 DAO 調整）。
