...
類別 | 比例 | 解鎖方式 | 資金用途與說明
創始團隊與顧問 | 15% | 上線時釋放 3%，其餘分 4 次，每 4 個月釋放一階段 | 用於激勵核心團隊與早期顧問長期參與與貢獻，強化項目的穩定發展與技術持續演進。鎖倉機制避免短期獲利套現，保障生態長期利益。
Paxi 基金會 | 10% | 上線時釋放 4%，其餘分 4 次，每 4 個月釋放一階段 | 用於鏈的核心維護與升級、法律合規、品牌建設及中長期戰略資源配置，包括開發者大會、國際推廣等，確保生態永續運作。
Paxi DAO | 5% | 上線時全部釋放 | 資金全數由社群治理投票決定使用方向，例如支援生態建設、獎勵提案實施者、社群工具開發等，體現完全去中心化治理與自治原則。
私募與戰略投資 | 15% | 上線時釋放 3%，其餘分 4 次，每 4 個月釋放一階段 | 用於引入長期戰略合作夥伴與資源，包括基礎設施協作、技術聯盟、市場擴展等，並鼓勵與基金、孵化器、交易所深度合作。
公開發售 | 45% | 全額釋放或依策略分階段解鎖 | 吸引廣泛社群參與，提升用戶持幣率與去中心化程度。資金將用於交易所上架費用、市值管理、初期流動性建設、社群營運、基礎設施資助與早期 dApp 開發支持，推動整體生態啟動與擴張。
用戶激勵與推廣 | 10% | 用於任務下載、邀請推薦、社群活動等動態發放 | 用於推動用戶增長與社群活躍度，例如任務平台、推薦獎勵、公會獎勵、社群內容創作激勵等，促進自然用戶擴散與品牌滲透。
